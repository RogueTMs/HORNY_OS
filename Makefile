...
kernel:
	...
	ld -m i386pe -o src/boot/kernel.tmp -Ttext 0x20200 src/boot/kernel.o src/boot/vga_funcs.o src/boot/utils_funcs.o src/boot/tramplins.o src/boot/kernel_alloc.o src/boot/kernel_panic.o
