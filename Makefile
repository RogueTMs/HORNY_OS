...
kernel:
	...
	nasm -felf32 src/boot/AXAXAXAXA.asm -o src/boot/AXAXAXAXA.o
	gcc -m32 -ffreestanding -c -o src/boot/console.o src/boot/console.c
	...
	ld -m i386pe -o src/boot/kernel.tmp -Ttext 0x20200 src/boot/kernel.o src/boot/tramplins.o src/boot/handlers.o src/boot/context.o src/boot/utils_funcs.o src/boot/console.o src/boot/vga_funcs.o src/boot/pics.o src/boot/kernel_alloc.o src/boot/kernel_panic.o src/boot/mem_funcs.o src/boot/ports.o src/boot/AXAXAXAXA.o
